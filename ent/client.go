...
// QueryStudying queries the studying edge of a List.
func (c *ListClient) QueryStudying(l *List) *UserQuery {
...
// QuerySettings queries the settings edge of a List.
func (c *ListClient) QuerySettings(l *List) *SettingsQuery {
...
// QueryList queries the list edge of a Settings.
func (c *SettingsClient) QueryList(s *Settings) *ListQuery {
...
func (c *SettingsClient) QueryUser(s *Settings) *UserQuery {
	query := &UserQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := s.ID
		step := sqlgraph.NewStep(
...
func (c *UserClient) QueryStudies(u *User) *ListQuery {
	query := &ListQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
